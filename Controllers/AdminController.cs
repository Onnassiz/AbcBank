...
namespace AbcBank.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Create(Administrator administrator)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    await SendAuthMail(administrator.Email);
                }
        ...
        private async Task SendAuthMail(string email)
        {
            ...
            Mailer.Send(email, "Set Up Password",
                $"You have been registered as an ABC Bank administrator. <br/><br/>Please click this : <a href='{callbackUrl}'>link</a> to setup your password");
